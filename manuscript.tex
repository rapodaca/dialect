...
A molecular tree is described at the lowest level by its constitution. In Dialect, constitution comprises those attributes locating nucleons and electrons at specific atoms and bonds. All other attributes lie outside the scope of constitution. Atomic attributes related to constitution are: \ttt{element}; \ttt{hydrogens}; and \ttt{charge}. Bond attributes related to constitution are \ttt{order} and \ttt{elided}.
